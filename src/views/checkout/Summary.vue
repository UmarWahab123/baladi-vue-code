<template>
                                                    ...
                                                    <tr class="cart_item">
                                                        ...
                                                        <td class="product-total">
                                                            <span class="woocommerce-Price-amount amount"><bdi><span
                                                                        class="woocommerce-Price-currencySymbol">$</span>749.90</bdi></span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                <tfoot>
                                                                    ...
                                                                    <input type="radio" name="shipping_method[0]"
                                                                        ...
                                                                        rate: <span
                                                                            class="woocommerce-Price-amount amount"><bdi><span
                                                                                    class="woocommerce-Price-currencySymbol">$</span>5.00</bdi></span></label>
                                                                </li>
                                                                <li>
                                                                    <input type="radio" name="shipping_method[0]"
                                                                        data-index="0"
                                                    ...
                                                    <tr class="order-total">
                                                        ...
                                                        <td><strong><span
                                                                    class="woocommerce-Price-amount amount"><bdi><span
                                                                            class="woocommerce-Price-currencySymbol">$</span>754.90</bdi></span></strong>
                                                        </td>
                                                    </tr>
 ...
 <router-link class="button alt" to="/order-confirmation">
                                                Place order </router-link>

                                                    <!-- <button type="" class="button alt" name="" id="" value="Place order"
