        ...
        <div class="module-wrapper">
          <div class="products column-4 mobile-2 total-4">
            <div
              ...
              :data="item"
              :key="indextr"
              v-for="(item, indextr) in productStore.NewarrivalProducts"
            >
  ...
  mounted() {
    ...
    axios
      ...
      .then((response) => {
        ...
        console.log("testing", this.arrivel);
        // const productStore = useProductStore();
    ...
    axios
      .get(
        "http://baladi-v1.bteamwebs.com/api/web/product/getcampaign?campaign_name=new-arrivel&locale=" +
          langCode
      )
      .then((response) => {
        ...
        const productStore = useProductStore();
        productStore.NewarrivalData(this.trends);
      })
      .catch((error) => {});
