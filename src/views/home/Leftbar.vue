                        ...
                        <div class="content-wrapper">
                          ...
                          <div class="product-countdown">
                            <div
                              ...
                              data-text="Expired"
                            >
                              <div class="count-item days">14</div>
                              <span>:</span>
                              <div class="count-item hours">14</div>
                              <span>:</span>
                              <div class="count-item minutes">29</div>
                              <span>:</span>
                              <div class="count-item second">04</div>
                            </div>
                            <!-- countdown -->
                        ...
                        <div class="content-wrapper">
                          <h3 class="product-title">
                            <a
                              ...
                              >OnePlus 8 Pro Onyx Black Android Smartphone</a
                            >
                          </h3>
                          <span class="price"
                            ><del aria-hidden="true"
