                  ...
                  >
                    <div class="banner dark align-top">
                      ...
                      <div class="banner-image">
                        <img
                          src="https://klbtheme.com/machic/wp-content/uploads/2021/09/banner-10.jpg"
                          alt="banner"
                        />
                      </div>
...
export default {
  ...
  mounted() {
    ...
    axios
      .get(
        "http://baladi-v1.bteamwebs.com/api/web/product/getcampaign?campaign_name=latest-seller&locale=" +
          langCode
      )
      .then((response) => {
        ...
        const productStore = useProductStore();
        productStore.LatestDealData(this.latestseller);
      })
      .catch((error) => {});
  ...
  methods: {
    ...
    closemodal() {
      (this.showmessage = "Loading..."), (this.showmodal = "");
      this.showmodalstyle = "";
    },
    clickbigmodal(event) {
