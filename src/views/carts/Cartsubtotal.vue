                                            ...
                                            <tbody>
                                                <tr class="cart-subtotal">
                                                    ...
                                                    <td data-title="Subtotal"><span
                                                            class="woocommerce-Price-amount amount"><bdi><span
                                                                    class="woocommerce-Price-currencySymbol">$</span>1,068.66</bdi></span>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td data-title="Shipping">
                                                            ...
                                                            <li>
                                                                <input type="radio" name="shipping_method[0]"
                                                                    ...
                                                                    for="shipping_method_0_flat_rate1">Flat rate: <span
                                                                        class="woocommerce-Price-amount amount"><bdi><span
                                                                                class="woocommerce-Price-currencySymbol">$</span>15.00</bdi></span></label>
                                                            </li>
                                                            <li>
                                                                <input type="radio" name="shipping_method[0]"
                                                     ...
                                                     <section id="shipping-cart"  v-if="changeaddress === '1'" class="shipping-calculator-form">
                                                                ...
                                                                <input type="hidden"
                                                                    ...
                                                                    value="c2729ad6b1"><input type="hidden"
                                                                    name="_wp_http_referer" value="/machic/cart/">
                                                            </section>
                                                        </form>
                                                ...
                                                <tr class="order-total">
                                                    ...
                                                    <td data-title="Total"><strong><span
                                                                class="woocommerce-Price-amount amount"><bdi><span
                                                                        class="woocommerce-Price-currencySymbol">$</span>1,083.66</bdi></span></strong>
                                                    </td>
                                                </tr>
