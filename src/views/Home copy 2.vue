                    ...
                    <div class="woocommerce-product-gallery">
                      <div class="images-wrapper">
                        ...
                        >
                          <div
                            ...
                            id="swiper-wrapper-8f4a4145fbebc43b"
                            aria-live="polite"
                            style="
                              height: 455px;
                          ...
                          >
                            ...
                            >
                              <a href="#"
                                ><img
                                  src="#wp-content/uploads/2021/09/single-1.jpg"
                              /></a>
                            </div>
                            <!-- swiper-slide -->
                            <div
                            ...
                            >
                              <a href="#">
                                <img
                                  src="#wp-content/uploads/2021/09/single-2.jpg"
                              /></a>
                            </div>
                            <!-- swiper-slide -->
                            <div
                            ...
                            >
                              <a href="#">
                                <img
                                  src="#wp-content/uploads/2021/09/single-3.jpg"
                              /></a>
                            </div>
                            <!-- swiper-slide -->
                            <div
                            ...
                            >
                              <a href="#">
                                <img src="#wp-content/uploads/2021/09/air3.jpg"
                              /></a>
                            </div>
                            <!-- swiper-slide -->
                            <div
                            ...
                            >
                              <a href="#">
                                <img src="#wp-content/uploads/2021/09/air4.jpg"
                              /></a>
                            </div>
                            <!-- swiper-slide -->
                          </div>
                      ...
                      <div class="thumbnails-wrapper">
                        ...
                        >
                          <div
                            class="swiper-wrapper"
                            id="swiper-wrapper-10f4a5329e1f365e7"
                            aria-live="polite"
                          ...
                          >
                            ...
                            >
                              <a href="#"
                                ><img
                                  src="#wp-content/uploads/2021/09/air3.jpg"
                              /></a>
                            </div>
                            <!-- swiper-slide -->
                            <div
                            ...
                            >
                              <a href="#"
                                ><img
                                  src="#wp-content/uploads/2021/09/air4.jpg"
                              /></a>
                            </div>
                            <!-- swiper-slide -->
                          </div>
                ...
                <div class="col col-12 col-lg-6">
                  ...
                  <div class="product-meta">
                    <div class="product-model">
                      <span>Model:</span> MYL92LL/A
                    </div>
                    <!-- product-model -->
                    <div class="sku-wrapper">
                      <span>SKU:</span> <span class="sku">BE45VGRT</span>
                    </div>
                    <!-- sku-wrapper -->
                  </div>
                  <!-- product-meta -->
                  ...
                  <div class="product_meta product-categories">
                    ...
                    <span class="posted_in"
                      >Categories:
                      <a href="#product-category/apple/" rel="tag">Apple</a>,
                      <a href="#product-category/cell-phones/" rel="tag"
                        >Cell Phones</a
                      ></span
                    >
                  </div>
    ...
    <aside class="site-offcanvas">
      <div class="site-scroll ps ps--active-y">
        ...
        <div class="site-offcanvas-row site-offcanvas-body">
          <div
            class="offcanvas-menu-container klb-menu"
            style="height: 1018px; transition-duration: 350ms"
          >
            <div
              class="offcanvas-menu-wrapper klb-menu-wrapper"
            ...
            >
              <nav class="site-menu vertical categories">
                ...
                <ul
                  ...
                  class="menu departments-menu collapse show"
                >
                  <li
                    id="menu-item-2121 menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-has-children menu-item-2122"
                  >
                    <img
                      class="strawbarry-icon"
                      src="./../assets/img/icon/strwbarry.png"
                    /><a class="next" href="#">Fresh</a>
                    <ul class="sub-menu">
                      <li
                        id="menu-item-2129"
              ...
              <div class="site-copyright">
                <p>
                  Copyright 2021 © Machic WordPress Theme. All right reserved.
                                    ...
                                    <div class="product-content">
                                      ...
                                      <div class="content-wrapper">
                                        <h3 class="product-title">
                                          <a href="#"
                                            >Samsung Galaxy A52 5G Android Cell
                                            Phone</a
                                          >
                                        </h3>
                                      ...
                                      <div class="thumbnail-wrapper">
                                        <a href="#">
                                          <img
                                            width="90"
                                            height="90"
                                            src="./../assets/product-15-90x90.jpg"
                                            class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                            alt=""
                                          />
                                        </a>
                ...
                <div class="site-departments large">
                  <div class="site-departments-wrapper">
                    ...
                    <ul
                      ...
                      class="departments-menu collapse show"
                    >
                      <li
                      ...
                      >
                        ...
                        <ul
                          class="sub-menu"
                          style="
                            background-image: url(./../assets/img/category-menu-3.png);
                            width: 580px;
                          "
                        >
                          <div class="container">
                                                  ...
                                                  >
                                                    ...
                                                    <ul class="sub-menu">
                                                      ...
                                                      <li class="">
                                                        <a class="link" href="#"
                                                          >shop more<img
                                                            src="src/style/icons/arrow-right-short.svg"
                                                        /></a>
                                                      </li>
                                                    </ul>
                                                  </li>
                      ...
                      >
                        <a href="#product-category/television-video/">
                          <div class="menu-icon">
                            <img
                              style="padding: 0px"
                              src="./../assets/img/icon/non-food.svg"
                            />
                          </div>
                          Groceries Non Food
                        </a>
                        <ul class="sub-menu">
                          ...
                          >
                            ...
                            <ul class="sub-menu">
                              ...
                              >
                                <a
                                  href="#product-category/television-video/vcrs/"
                                  >VCRs</a
                                >
                              </li>
                              <li
                      ...
                      >
                        <a href="#product-category/smartwatches/">
                          <div class="menu-icon">
                            <img
                              style="padding: 0px"
                              src="./../assets/img/icon/health.svg"
                            />
                          </div>
                          Health & Beauty
                        </a>
                        <ul
                          class="sub-menu"
                          style="
                            background-image: url('./../assets/img/category-menu-2.png');
                            width: 485px;
                          "
                        >
                          <li
                      ...
                      >
                        <a href="#product-category/headphones/">
                          <div class="menu-icon">
                            <i class="klbth-icon-headphones"></i>
                          </div>
                          Headphones
                        </a>
                      </li>
                      ...
                      >
                        <a href="#product-category/video-games/">
                          <div class="menu-icon">
                            <i class="klbth-icon-play-station"></i>
                          </div>
                          Video Games
                        </a>
                      </li>
                      ...
                      >
                        <a href="#product-category/sports-outdoors/">
                          <div class="menu-icon">
                            <i class="klbth-icon-virtual-reality"></i>
                          </div>
                          Sports &amp; Outdoors
                        </a>
                      </li>
                      ...
                      >
                        <a href="#?orderby=popularity">
                          <div class="menu-icon">
                            <i class="klbth-icon-data-transfer-up"></i>
                          </div>
                      ...
                      >
                        <a href="#">
                          <div class="menu-icon">
                            <i class="klbth-icon-shopping-bag-arrow-up"></i>
                          </div>
                          Top 100 Offers
                        </a>
                      </li>
                          ...
                          <div class="product-wrapper">
                            <div class="product-content">
                              <div class="thumbnail-wrapper">
                                <a href=""
                                  ><img
                                    src="./../assets/img/single-1-400x400.jpg"
                          ...
                          <div class="product-wrapper">
                            <div class="product-content">
                              ...
                              <div class="content-wrapper">
                                <h3 class="product-title">
                                  <a href="#"
                                    >Apple iPhone 11 64GB Yellow Fully
                                    Unlocked</a
                                  >
                                </h3>
                                <div class="product-rating">
                                  ...
                                  >
                                    <span style="width: 80%"
                                      >Rated
                                      <strong class="rating">4.00</strong> out
                                      of 5</span
                                    >
                                  </div>
                                  <div class="count-rating">
                              ...
                              <div class="thumbnail-wrapper">
                                <a href="#"
                                  ><img
                                    ...
                                    alt="OnePlus 8 Pro Onyx Black Android Smartphone"
                                /></a>
                              </div>
                              <!-- thumbnail-wrapper -->
                              <div class="content-wrapper">
                                <h3 class="product-title">
                                  <a href="#"
                                    >OnePlus 8 Pro Onyx Black Android
                                    Smartphone</a
                                  >
                                </h3>
                                <div class="product-rating">
                                  ...
                                  >
                                    <span style="width: 60%"
                                      >Rated
                                      <strong class="rating">3.00</strong> out
                                      of 5</span
                                    >
                                  </div>
                                  <div class="count-rating">
                          ...
                          <div class="product-wrapper">
                            <div class="product-content">
                              ...
                              <div class="content-wrapper">
                                <h3 class="product-title">
                                  <a href="#"
                                    >SAMSUNG Galaxy Watch Active 2 Aluminum</a
                                  >
                                </h3>
                                <div class="product-rating">
                                  <div
                          ...
                          <div class="product-wrapper">
                            <div class="product-content">
                              ...
                              <div class="content-wrapper">
                                <h3 class="product-title">
                                  <a href="#"
                                    >Bose Noise Cancelling Wireless Bluetooth</a
                                  >
                                </h3>
                                <div class="product-rating">
                                  <div
                                ...
                                <div class="product-meta">
                                  ...
                                  <div class="product-message color-danger">
                              ...
                              <div class="thumbnail-wrapper">
                                <a
                                  ...
                                  ><img
                                    ...
                                    alt="Echo Dot (4th Gen, 2020 release) | Smart speaker"
                                /></a>
                              </div>
                              <!-- thumbnail-wrapper -->
                              <div class="content-wrapper">
                                <h3 class="product-title">
                                  <a
                                    href="#product/echo-dot-4th-gen-2020-release-smart-speaker/"
                                    >Echo Dot (4th Gen, 2020 release) | Smart
                                    speaker</a
                                  >
                                </h3>
                                <div class="product-rating">
                  ...
                  <div class="fl-mini-cart-content">
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          class="swiper-wrapper"
                          id="swiper-wrapper-276c607181dea1066"
                          aria-live="polite"
                        ...
                        <div
                          ...
                          role="button"
                          aria-label="Previous slide"
                          aria-controls="swiper-wrapper-276c607181dea1066"
                          aria-disabled="false"
                        ></div>
                        <div
                          class="swiper-button-next"
                    ...
                    <p class="woocommerce-mini-cart__buttons buttons">
                      ...
                      ><a href="#checkout/" class="button checkout wc-forward"
                        >Checkout</a
                      >
                    </p>
                  </div>
