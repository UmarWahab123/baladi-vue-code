        ...
        <div class="elementor-section-wrap">
          ...
          >
            <div class="elementor-container elementor-column-gap-default">
              <div
                class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-4ab42f83"
                data-id="4ab42f83"
                data-element_type="column"
              >
                <div class="elementor-widget-wrap elementor-element-populated">
                  <div
                    class="elementor-element elementor-element-9d7fa95 elementor-widget elementor-widget-text-editor"
                    data-id="9d7fa95"
                  ...
                  >
                    <div class="elementor-widget-container">
                      ...
                      <p>
                        ...
                        received your refund yet, please contact us at {email
                        address}.
                      </p>
                      <!-- /wp:paragraph -->
                      ...
                      <p>
                        ...
                        email at {email address} and send your item to:
                        {physical address}.
                      </p>
                      <!-- /wp:paragraph -->
