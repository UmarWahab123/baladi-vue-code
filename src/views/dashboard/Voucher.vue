                            ...
                            <div class="my-account-wrapper">
                               ...
                               <Sidebar/>
                                <div class="woocommerce-MyAccount-content">
                                    ...
                                    <section class="row p-3" id="labels">
                                        <div class="col-md-12">
                                                ...
                                                <div class="row no-gutters">
                                                    <div class="col-md-4 border-right">
                                                        <div class="d-flex flex-column align-items-center"><img
                                                                class="img-coupon"
                                                                src="https://cdnprod.mafretailproxy.com/sys-master-root/h34/hee/16315428110366/246675_main.jpg_200Wx200H"><span
                                                                class="d-block">I phone 12</span><span
                                                                class="text-white">Mobile</span></div>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div>
