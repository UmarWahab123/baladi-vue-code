                            ...
                            <div class="subscribe-form">
                                ...
                                <form id="mc4wp-form-1" class="mc4wp-form mc4wp-form-1852" method="post" data-id="1852"
                                    ...
                                    <div class="mc4wp-form-fields">
                                        <input type="email" class="subscribe-input" name="EMAIL"
                                    ...
                                    <input type="hidden" name="_mc4wp_timestamp" value="1643343130">
                        ...
                        <div class="menu-make-money-with-us-container">
                            <ul id="menu-make-money-with-us" class="menu">
                                ...
                                <li id="menu-item-2179"
                                    class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2179">
                                    <a href="#">Advertise
                                        Your Products</a>
                                </li>
                                <li id="menu-item-2180"
                                    class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2180">
                                    <a href="#">Sell-Publish with Us</a>
                                </li>
                                <li id="menu-item-2181"
                                    class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2181">
                                    <a href="#">Become an
                                        Machic Vendor</a>
                                </li>
                            </ul>
                ...
                <div class="col col-12 col-lg-3 col-five">
                    <div class="klbfooterwidget widget woocommerce widget_product_categories">
                        ...
                        <ul class="product-categories">
                            ...
                            <li class="cat-item cat-item-40"><a href="#">Camera &amp; Photo</a></li>
                            <li class="cat-item cat-item-42 cat-parent"><a href="#">Cell Phones</a></li>
                            <li class="cat-item cat-item-44 cat-parent"><a href="#">Computers &amp; Accessories</a>
                            </li>
                            <li class="cat-item cat-item-51"><a href="#">Headphones</a></li>
                            <li class="cat-item cat-item-90"><a href="#">Smartwatches</a></li>
                            <li class="cat-item cat-item-93"><a href="#">Sports &amp; Outdoors</a></li>
                            <li class="cat-item cat-item-96"><a href="#">Television &amp; Video</a></li>
                            <li class="cat-item cat-item-103"><a href="#">Video Games</a></li>
                        </ul>
                    </div>
                </div>
                <!-- col -->
                ...
                <div class="col">
                        ...
                        <div class="site-social">
                            <ul>
                                ...
                                <li><a href="https://www.youtube.com/" target="_blank"><i
                                            class="klbth-icon-youtube"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- site-details -->
                    ...
                    <div class="site-details">
                        <ul class="tags">
                            ...
                            <li><a href="#product-tag/samsung-galaxy-s5-64gb/">Samsung Galaxy S5 - 64gb </a></li>
                            <li><a href="#product-tag/samsung-galaxy-tab-4/">Samsung Galaxy Tab 4 </a></li>
    ...
    <div
        ...
        <form class="dgwt-wcas-search-form" role="search" action="#" method="get">
            <div class="dgwt-wcas-sf-wrapp">
                ...
                <input id="dgwt-wcas-search-input-2" type="search" class="dgwt-wcas-search-input" name="s" value=""
...
<div class="mobile-bottom-menu">
    <div class="mobile-bottom-menu-wrapper">
        <nav class="mobile-menu">
            <ul>
                <li> <a href="#" class="store"> <i class="klbth-icon-shop"></i> <span>Store</span> </a> </li>
                <li> <a href="#" class="search"> <i class="klbth-icon-search"></i> <span>Search</span> </a> </li>
                <li> <a href="#" class="wishlist"> <i class="klbth-icon-heart"></i> <span>Wishlist</span> </a> </li>
                <li> <a href="#" class="user"> <i class="klbth-icon-user-1"></i> <span>Account</span> </a> </li>
                <li class="menu-item"> <a href="#" class="categories"> <i class="klbth-icon-menu-scale"></i>
...
<div id="woosc-area" class="woosc-area woosc-bar-bottom woosc-bar-right woosc-bar-click-outside-yes woosc-hide-checkout"
    data-bg-color="#292a30" data-btn-color="#00a0d2" data-count="2">
    <div class="woosc-inner">
        <div class="woosc-table" style="background-color: rgb(41, 42, 48);">
        ...
        <div class="woosc-bar " data-count="2" style="background-color: rgb(41, 42, 48);">
