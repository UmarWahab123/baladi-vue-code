  ...
  <div class="col col-12 col-lg-9 content-primary">
    <div class="products column-4 mobile-2" v-if="isCount">
      ...
      >
        ...
        <div class="product-content-fade" style="margin-bottom: -109px"></div>
        <div
          class="
            tinv-wraper
            woocommerce
      ...
      <div
        class="
          ...
          custom-hover
        "
        v-for="(items, indextr) in filterresults"
      >
        <div class="product-wrapper product-type-1">
          <div class="product-content">
            <div class="thumbnail-wrapper">
            ...
            <div class="content-wrapper">
              <h3 class="product-title">
                <router-link
                  :to="'/' + langCode + '/product-detail/' + item?.slug"
                  >{{ items?.product_name }}</router-link
                >
              </h3>
              <div class="product-rating">
                <div
                  ...
                  ><del aria-hidden="true"
                    ><span class="woocommerce-Price-amount amount">
                      <bdi
                        ><span class="woocommerce-Price-currencySymbol"
                          >{{ $t("QAR") }} </span
                        >{{ items?.uom_products?.previous_price }}</bdi
                      >
                    </span></del
                  >
                  <ins
                    ...
                    >
                      <bdi
                        ><span class="woocommerce-Price-currencySymbol"
                          >{{ $t("QAR") }} </span
                        >{{ item?.uom_products?.regular_price }}</bdi
                      >
                    </span></ins
                  ></span
                ><a
